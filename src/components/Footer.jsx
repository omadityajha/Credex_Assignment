      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-gray-300">123 Tech Avenue</li>
              <li className="text-gray-300">San Francisco, CA 94107</li>
              <li className="text-gray-300">info@softsell.com</li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-400">
          ...
          <div className="flex justify-center mt-4 space-x-6">
            <a href="#" className="text-gray-400 hover:text-white transition">About SoftSell</a>
